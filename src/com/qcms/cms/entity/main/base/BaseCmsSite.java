...
public abstract class BaseCmsSite  implements Serializable {
	...
	public BaseCmsSite (
		...
		com.qcms.cms.entity.main.CmsConfig config,
	...
	// many to one
	private com.qcms.core.entity.Ftp uploadFtp;
	private com.qcms.cms.entity.main.CmsConfig config;
	 ...
	 */
	public com.qcms.core.entity.Ftp getUploadFtp () {
		return uploadFtp;
	}
	 ...
	 */
	public void setUploadFtp (com.qcms.core.entity.Ftp uploadFtp) {
	 ...
	 */
	public com.qcms.cms.entity.main.CmsConfig getConfig () {
		return config;
	}
	 ...
	 */
	public void setConfig (com.qcms.cms.entity.main.CmsConfig config) {
		this.config = config;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.qcms.cms.entity.main.CmsSite)) return false;
		else {
			com.qcms.cms.entity.main.CmsSite cmsSite = (com.qcms.cms.entity.main.CmsSite) obj;
