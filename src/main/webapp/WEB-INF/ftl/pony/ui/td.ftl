...
<#macro td id=""
	...
	>
<#if label!="">
<td<#if id?? && id!=""> id="${id}"</#if> width="${labelWidth}%" class="pn-flabel<#if noHeight=='false'> pn-flabel-h</#if>"><#if required!="false"><span class="pn-frequired">*</span></#if><@ss.mt code=label text=label/><#if hasColon="true">${colon}</#if></td><#rt/>
...
<#if help!='' && helpPosition=='2'>
 <span class="pn-fhelp"><@ss.mt code=help text=help/></span><#rt/>
<#elseif help!='' && helpPosition=='3'>
<div class="pn-fhelp"><@ss.mt code=help text=help/></div><#rt/>
</#if>
</td><#rt/>
</#macro>
