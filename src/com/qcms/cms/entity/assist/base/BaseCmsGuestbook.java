...
public abstract class BaseCmsGuestbook  implements Serializable {
	...
	public BaseCmsGuestbook (
		...
		com.qcms.cms.entity.assist.CmsGuestbookCtg ctg,
		java.lang.String ip,
	...
	// one to one
	private com.qcms.cms.entity.assist.CmsGuestbookExt ext;

	// many to one
	private com.qcms.cms.entity.main.CmsUser member;
	private com.qcms.cms.entity.main.CmsUser admin;
	private com.qcms.cms.entity.main.CmsSite site;
	private com.qcms.cms.entity.assist.CmsGuestbookCtg ctg;
	 ...
	 */
	public com.qcms.cms.entity.assist.CmsGuestbookExt getExt () {
		return ext;
	}
	 ...
	 */
	public void setExt (com.qcms.cms.entity.assist.CmsGuestbookExt ext) {
		this.ext = ext;
	}
	 ...
	 */
	public com.qcms.cms.entity.main.CmsUser getMember () {
		return member;
	}
	 ...
	 */
	public void setMember (com.qcms.cms.entity.main.CmsUser member) {
		this.member = member;
	}
	 ...
	 */
	public com.qcms.cms.entity.main.CmsUser getAdmin () {
		return admin;
	}
	 ...
	 */
	public void setAdmin (com.qcms.cms.entity.main.CmsUser admin) {
		this.admin = admin;
	}
	 ...
	 */
	public com.qcms.cms.entity.assist.CmsGuestbookCtg getCtg () {
		return ctg;
	}
	 ...
	 */
	public void setCtg (com.qcms.cms.entity.assist.CmsGuestbookCtg ctg) {
		this.ctg = ctg;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.qcms.cms.entity.assist.CmsGuestbook)) return false;
		else {
			com.qcms.cms.entity.assist.CmsGuestbook cmsGuestbook = (com.qcms.cms.entity.assist.CmsGuestbook) obj;
