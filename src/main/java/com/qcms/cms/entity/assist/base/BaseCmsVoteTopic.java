...
public abstract class BaseCmsVoteTopic  implements Serializable {
	...
	// collections
	private java.util.Set<com.qcms.cms.entity.assist.CmsVoteItem> items;
	 ...
	 */
	public java.util.Set<com.qcms.cms.entity.assist.CmsVoteItem> getItems () {
		return items;
	}
	 ...
	 */
	public void setItems (java.util.Set<com.qcms.cms.entity.assist.CmsVoteItem> items) {
		this.items = items;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.qcms.cms.entity.assist.CmsVoteTopic)) return false;
		else {
			com.qcms.cms.entity.assist.CmsVoteTopic cmsVoteTopic = (com.qcms.cms.entity.assist.CmsVoteTopic) obj;
